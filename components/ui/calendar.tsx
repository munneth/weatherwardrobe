...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-.5 [--cell-size:2rem] max-w-[18rem] rounded-lg shadow-md [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        root: cn("w-fit max-w-[12rem]", defaultClassNames.root),
        ...
        month_caption: cn("flex items-center justify-center h-[var(--cell-size)] w-full px-2", defaultClassNames.month_caption),
